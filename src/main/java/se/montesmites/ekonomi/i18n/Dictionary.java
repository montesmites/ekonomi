...
public final class Dictionary {
  ...
  public static final TranslationType EVENT_NO =
      TranslationType.canonical("Event no", "Händelse-nr");
  public static final TranslationType FISCAL_YEAR =
      TranslationType.canonical("Fiscal year", "Räkenskapsår");
  public static final TranslationType FISCAL_YEAR_ID =
      TranslationType.canonical("Fiscal year id", "Räkenskapsår-id");
